...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="hero-blob absolute bottom-1/4 -right-20 w-96 h-96 bg-cyan-500/10 blur-[120px] rounded-full"
      ...
      <div className="relative z-10 text-center lg:text-left max-w-4xl lg:w-3/5">
        ...
        <h1 className="hero-title text-6xl md:text-8xl font-bold tracking-tight mb-12">
          ...
          <div className="overflow-hidden inline-block text-emerald-400">
            <span>SAINI</span>
          </div>
          <br />
          <div className="overflow-hidden inline-block text-slate-400">
            <span>WEB</span>
          </div>
        ...
        <div className="hero-btn flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
          <a
            href="#contact"
            className="group px-8 py-4 bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-bold rounded-xl flex items-center justify-center gap-2 transition-all"
          >
            Get in touch
            <ArrowRight
              size={20}
          ...
          <a
            href="https://drive.google.com/file/d/1iUUNvzTG7ByX5jlzaB7ublRfNG-2AJ7f/view?usp=drivesdk"
            target="_blank"
          ...
          <a
            href="#projects"
            className="px-8 py-4 bg-slate-800 hover:bg-slate-700 border border-slate-700 text-slate-100 font-bold rounded-xl flex items-center justify-center gap-2 transition-all"
          >
            Work
            <Code size={20} />
          </a>
